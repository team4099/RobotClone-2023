...
object GroundIntakeIONeo : GroundIntakeIO {
  private val rollerSparkMax = CANSparkMax(Constants.GroundIntake.ROLLER_MOTOR_ID,
    CANSparkMaxLowLevel.MotorType.kBrushless)
  private val armSparkMax = CANSparkMax(Constants.GroundIntake.ARM_MOTOR_ID,
    CANSparkMaxLowLevel.MotorType.kBrushless)
  ...
  private val armSensor = sparkMaxAngularMechanismSensor(
    armSparkMax,
    GroundIntakeConstants.ARM_GEAR_RATIO.asDrivenOverDriving,
    GroundIntakeConstants.ARM_VOLTAGE_COMPENSATION
  )

  private val throughBoreEncoder = DutyCycleEncoder(Constants.GroundIntake.REV_ENCODER_PORT)
  ...
  init {
    ...
    rollerSparkMax.enableVoltageCompensation(GroundIntakeConstants.ROLLER_VOLTAGE_COMPENSATION.inVolts)
    ...
    armSparkMax.enableVoltageCompensation(GroundIntakeConstants.ARM_VOLTAGE_COMPENSATION.inVolts)
    ...
    MotorChecker.add(
      ...
      "Arm",
      MotorCollection(
        mutableListOf(Neo(armSparkMax, "Arm Motor")),
  ...
  override fun zeroEncoder() {
    armSparkMax.encoder.position = armSensor.positionToRawUnits(armAbsolutePosition)
  }
