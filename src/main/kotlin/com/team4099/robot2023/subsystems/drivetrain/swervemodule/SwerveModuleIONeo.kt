...
class SwerveModuleIONeo(
  ...
  private val throughBoreEncoder = steeringMotor.getAlternateEncoder(
  ...
  init {
    ...
    steeringMotor.enableVoltageCompensation(DrivetrainConstants.STEERING_COMPENSATION_VOLTAGE.inVolts)
    ...
    driveMotor.setSmartCurrentLimit(DrivetrainConstants.DRIVE_STATOR_CURRENT_LIMIT.inAmperes.toInt())
